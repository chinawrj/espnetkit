...
void lv_obj_set_style_bg_img_tiled(struct _lv_obj_t * obj, bool value, lv_style_selector_t selector) // @suppress("Type cannot be resolved")
{
    lv_style_value_t v = {
        .num = (int32_t)value
    };
...
void lv_obj_set_style_border_post(struct _lv_obj_t * obj, bool value, lv_style_selector_t selector)// @suppress("Type cannot be resolved")
{
    lv_style_value_t v = {
        .num = (int32_t)value
    };
...
void lv_obj_set_style_line_rounded(struct _lv_obj_t * obj, bool value, lv_style_selector_t selector)// @suppress("Type cannot be resolved")
{
    lv_style_value_t v = {
        .num = (int32_t)value
    };
...
void lv_obj_set_style_arc_rounded(struct _lv_obj_t * obj, bool value, lv_style_selector_t selector)// @suppress("Type cannot be resolved")
{
    lv_style_value_t v = {
        .num = (int32_t)value
    };
...
void lv_obj_set_style_clip_corner(struct _lv_obj_t * obj, bool value, lv_style_selector_t selector)// @suppress("Type cannot be resolved")
{
    lv_style_value_t v = {
        .num = (int32_t)value
    };
